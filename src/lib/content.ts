...
export const carouselSlides: CarouselSlide[] = [
  {
    ...
    caption: 'Helping shape the city — where people move, we go.',
    image: peekSlideImages.metro,
  ...
  },
  {
    id: '2',
    title: 'Mind the gap',
    caption: 'Everyday streets. Real lives. Jesus in the middle of it.',
    image: peekSlideImages.tube,
  ...
  },
  {
    id: '3',
    title: 'After dark',
    caption: 'Shaping lives when the city is still awake — for Jesus.',
    image: peekSlideImages.tram,
    ctaLabel: 'Our vision',
    ctaHref: '/about',
  },
  {
