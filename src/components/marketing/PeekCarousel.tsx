      ...
      <div className="py-14 sm:py-16">
        ...
        >
          ...
          <motion.div
            aria-hidden
            className={cn(
              'pointer-events-none absolute top-0 left-0 z-30 hidden size-[4.25rem] items-center justify-center rounded-full bg-lime font-mono text-[10px] font-bold uppercase tracking-wider text-lime-foreground shadow-[4px_4px_0_0_#000] transition-opacity duration-150 sm:flex',
